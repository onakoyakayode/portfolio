  ...
  return (
    <div id='about' className='flex flex-col items-center px-3 md:px-[20px] lg:px-[50px] py-[60px] md:py-[70px] lg:py-[80px] xl:py-[100px]'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 items-center justify-between text-xs lg:text-sm'>
        ...
        <div className='w-full'>
            <p className='my-1 md:my-2 lg:my-5 leading-6 font-serif text-[14px] md:text-[15px] lg:text-[16px]'>Through my journey as a web developer, I have gained knowledge in programming languages such as JavaScript and Solidity. These skills have been instrumental in enhancing my artistic creations and I continue to apply them daily.</p>
            <p className='my-1 md:my-2 lg:my-5 leading-6 font-serif text-[14px] md:text-[15px] lg:text-[16px]'>I have experience in collaborating with designers, product managers, and backend developers to ensure that the frontend meets the requirements of the project and delivers the best possible user experience. I am also well-versed in using version control tools like Git and am comfortable working with agile development methodologies.</p>
            <p className='my-1 md:my-2 lg:my-5 leading-6 font-serif text-[14px] md:text-[15px] lg:text-[16px]'>I am passionate about creating elegant and efficient frontend solutions that deliver the best experience to users. If you have any frontend development needs or questions, feel free to reach out to me. I would be more than happy to help!</p>
        </div>
      </div>
